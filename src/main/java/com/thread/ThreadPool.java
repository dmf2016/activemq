...
public class ThreadPool {
     ...
     * 默认线程池
     */
    public static ThreadPoolExecutor mThreadPoolExecutor = new ThreadPoolExecutor(WORK_MIN, WORK_MAX, KEEP_ALIVE_TIME,
            TimeUnit.SECONDS, mWorkQueue, mRejectedExecutionHandler);
    /**
     * 阻塞执行的线程池
     */
    private static ThreadPoolExecutor mRejectedThreadPoolExecutor = new ThreadPoolExecutor(0, 1, KEEP_ALIVE_TIME,
            TimeUnit.SECONDS, mRejectedWorkQueue, new ThreadPoolExecutor.CallerRunsPolicy());
